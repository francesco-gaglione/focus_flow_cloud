...
pub fn api_routes(state: AppState) -> Router<AppState> {
    ...
    let version_routes = Router::new().nest("/version", crate::shared::http::version::routes::router());

    let protected_routes = Router::new()
        .nest("/category", crate::tasks::http::category::routes::router())
        .nest("/task", crate::tasks::http::task::routes::router())
        .nest("/focus-session", crate::tasks::http::session::routes::router())
        .nest("/setting", crate::user::http::user_setting::routes::router())
        ...
        .nest("/reminders", crate::shared::http::reminder::routes::router())
