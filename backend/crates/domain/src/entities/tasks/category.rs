...
impl Category {
    pub fn create(user_id: Uuid, name: String, color: String) -> CategoryResult<Self> {
...
mod category_tests {
    ...
    fn test_new_category_valid() {
        ...
        let result = Category::create(user_id, name.clone(), color.clone());
    ...
    fn test_new_category_invalid_color() {
        ...
        let result = Category::create(user_id, name, color);
    ...
    fn test_reconstitute_valid() {
        ...
        let result = Category::reconstitute(id, user_id, name.clone(), color.clone());
    ...
    fn test_reconstitute_invalid_color() {
        ...
        let result = Category::reconstitute(id, user_id, name, color);
    ...
    fn test_update_category_fields() {
        let user_id = Uuid::new_v4();
        let mut category =
            Category::create(user_id, "Old Name".to_string(), "#000000".to_string()).unwrap();
