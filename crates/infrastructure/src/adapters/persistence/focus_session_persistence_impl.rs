...
use application::traits::focus_session_persistence::FocusSessionPersistence;
...
use application::use_cases::persistance_command::find_session_by_filters_data::FindSessionByFiltersData;
