<div class="flex-1 flex flex-col items-center justify-center gap-4 text-center px-6 pb-32">
    ...
    <div>
        <h2 class="text-lg font-semibold text-surface-100">Flash<em class="text-primary-400 not-italic">cards</em></h2>
        <p class="text-sm text-surface-500 mt-1">Flashcard study mode is coming soon.</p>
        <p class="text-sm text-surface-500">Stay focused!</p>
    </div>
    <span class="badge preset-tonal-surface text-xs">Soon</span>
</div>
